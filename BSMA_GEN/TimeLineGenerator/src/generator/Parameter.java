...
public class Parameter{
	...
	public Parameter(String startTime,String endTime,int userNum, boolean isIndex, String btreePath, int cacheSize,int windowSize) throws ParseException{
		this.isIndex = isIndex;
		if(isIndex){
			this.btree = new Btree(btreePath,cacheSize);
    	...
    	String line = null; 
		try{
			BufferedReader hourFile = new BufferedReader(new FileReader("././data/hour"));
        	BufferedReader dayFile = new BufferedReader(new FileReader("././data/day"));
        	BufferedReader postRateFile = new BufferedReader(new FileReader("././data/userProportyCPD"));
        	BufferedReader internalCDFFile = new BufferedReader(new FileReader("././data/retweetIntervalCPD_hour"));
        	BufferedReader followerListFile = new BufferedReader(new FileReader("././data/network"+userNum));
