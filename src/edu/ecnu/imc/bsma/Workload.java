...
public abstract class Workload
{
	 ...
	 * operations and mutations on threadstate. Mutations to threadstate do not
	 * need to be synchronized, since each thread has its own threadstate
	 * instance.
	 * 
	 * @return false if the workload knows it is done for this thread. Client
	 *         will terminate the thread. Return true otherwise. Return true for
	 ...
	 *         when you are done.
	 */
	public abstract boolean doAnalysis(DB db, Object threadstate);
}
